...
namespace ComputerShop.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ComputerShopContext context)
        {
            _context = context;
        }
        ...
        {
            var allCustomers = _context.Customers.FromSqlRaw("dbo.CustomerSelectAll").ToList();
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var customer = _context.Customers.FromSqlRaw($"dbo.CustomerSelect '{id}'").ToList().FirstOrDefault();
            if (customer == null)
            {
                return NotFound();
            }
